...
class Config(object):
    ...
    INFOPIC = True
    URL = None
    SPAMWATCH_API = "KeCfL7BeBo5vTZIHPDWh7_KDOUdd37d5_MfH2Y5FYMBi0DJA4Vn88whSHUnxN57U"  # go to support.spamwat.ch to get key
    SPAMWATCH_SUPPORT_CHAT = "@IMPERILMENT_SUPPORT"
